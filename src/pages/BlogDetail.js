  ...
  return (
    <>
      ...
      <main role="main">
        <link
          rel="stylesheet"
          href={process.env.PUBLIC_URL + "/css/style.min.css"}
          type="text/css"
        />
                ...
                <div className="content-container">
                  <div className="posts">
                    <div className="__item">
                      <img
                        width="100%"
                        src={process.env.PUBLIC_URL + "/img/gallery_img/4.jpg"}
                        alt="demo"
                      />
                      <div className="__content">
                        ...
                        <p>
                          We believe in helping brands create{" "}
                          <a href="/">through strategy</a>, story-telling,
                          digital products, and integrated experiences on web,
                          mobile, and in the world. And you're here, friends,
                        ...
                        <p>
                          ...
                          cinematography. Designers, engineers, creatives,
                          makers, developers, artists, unite. Let’s do something
                          real-special together.Our team has a passion for
                          making things with real value. This has led us to
                          assemble a multi-talented group that can do just about
                          anything: from building sets to photographing food,
                          crafting websites to developing apps, beautiful design
                          to adventure cinematography.
                        </p>
                        <blockquote className="blockquot">
                          <p>
                            <i>
                              This has led us to assemble a multi-talented group
                              that can do just about anything: from building
                              sets to photographing food, crafting websites to
                              developing apps, beautiful design to adventure
                              cinematography. Designers, engineers, creatives,
                            </i>
                        ...
                        <p>
                          We believe in helping brands create through strategy,
                          story-telling, digital products, and integrated
                          experiences on web, mobile, and in the world. And
                          you're here, friends, because you also believe.
                        </p>
                        <p>
                          Our team has a passion for making things with real
                          value. This has led us to assemble a multi-talented
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td width="100%">
                              <time className="comment__date-post">
                                April 12, 2017
                              </time>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div className="text-right">
                                <a
                                  className="comment__reply custom-btn custom-btn--tiny custom-btn--style-1"
                                  href="/"
                                >
                                  REPLY
                                </a>
                              ...
                              <tr>
                                ...
                                <td>
                                  <p>
                                    ...
                                    with real value. This has led us to assemble
                                    a multi-talented group that can do just
                                    about anything: from building sets to
                                    photographing food, crafting websites to
                                    developing apps, beautiful design to
                                    adventure cinematography. Designers,
                                    engineers, creatives, makers, developers,
                                    artists, unite.
                                  </p>
                                  <div className="text-right">
                                    <a
                      ...
                      <div className="col-12 col-md-auto mb-6">
                        <div className="share-btns">
                          <ul>
                            <li>
                              <a className="fb" href="/">
                                <i className="fontello-facebook" />
                                facebook
                              </a>
                            </li>
                            <li>
                              <a className="tw" href="/">
                                <i className="fontello-twitter" />
                                twitter
                              </a>
                            </li>
                            <li>
                              <a className="ggl" href="/">
                                <i className="fontello-gplus" />
                                google plus
                              </a>
                            </li>
                            <li>
                              <a className="pt" href="/">
                                <i className="fontello-pinterest-circled" />
                                pinterest
                              </a>
                            </li>
                          </ul>
                ...
                <aside className="sidebar">
                  <div className="widget widget--text">
                    ...
                    <p>
                      We believe in helping brands create through strategy,
                      story-telling, digital products, and integrated
                      experiences on web, mobile, and in the world.
                    </p>
                  </div>
                  ...
                  <div className="widget widget--banner">
                    <a href="/">
                      <img
                        className="img-fluid  lazy"
                        src="img/blank.gif"
                        data-src="img/widget_banner.jpg"
                        alt="demo"
                      />
                    </a>
                  </div>
                ...
                <a className="post-nav__link post-nav__link--prev" href="/">
                  <span className="d-table">
                    <span className="d-table-cell align-middle">
                      <i className="ico fontello-left-1" />
                    </span>
                    <span className="d-table-cell align-middle">
                      Previous reading
                      <span className="name">
              ...
              <li className="post-nav__item">
                <a className="post-nav__link post-nav__link--next" href="/">
                  <span className="d-table">
                    ...
                    <span className="d-table-cell align-middle">
                      <i className="ico fontello-right-1" />
                    </span>
                  </span>
                </a>
              </li>
        ...
        <section className="section section--dark-bg">
          <div className="container">
            ...
            <form
              className="contact-form js-contact-form"
              action="/"
              data-aos="fade"
            >
              <div className="row">
